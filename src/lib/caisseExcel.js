...
import { categoryLabel, signedAmount } from './caisse'
...
export async function downloadCaisseExcel(entries, { onProgress, includePhotos = true, filename } = {}) {
  ...
  saveAs(blob, filename || `Registre_Caisse_${todayISO()}.xlsx`)
}
